...
FF=['a0','a1','a2','a3','a4','a5','a6','a7','a8','a11','b0','b1',
    'b2','b3','b4','b5','b6','b7','b8','b9','b10','b11','b14'];

#initialize entities after defending in failed set to FF
DFF=copy.deepcopy(FF);

#IDRs containing only failed entities and IDRs of initial failed entities removed
#[['x0'],['x1','x2'],['x3']] represents the IDR x0 <-x1 x2 +x3
IDR=[[['a2'],['b2']],[['a3'],['b0'],['b6','b14']],[['a5'],['b10']],
     [['a6'],['b4'],['b10']],[['a7'],['b4']],
     [['b0'],['a3','a8'],['a4']],[['b1'],['a4']],[['b2'],['a2','a11'],['a4']],
     [['b3'],['a1']],[['b5'],['a0']],
     [['b6'],['a3'],['a5']],[['b7'],['a3'],['a5']],[['b8'],['a0'],['a3']],[['b9'],['a1']],
     [['b11'],['a1'],['a4']]];
