...
public class DataGroup3_EntityHardening_Defender_ILP {
	private int K=1;
	...
	public DataGroup3_EntityHardening_Defender_ILP(int attackerBudget) {
		try {
			cplex = new IloCplex();
	...
	public static void main(String args[]) {
		...
		for (int bgt=3;bgt<8;bgt++) {
			DataGroup3_EntityHardening_Defender_ILP ex = new DataGroup3_EntityHardening_Defender_ILP(attackerBgt);
