...
public class DataGroup1_EntityHardening_Defender_ILP {
	private int K=1;
	...
	DataGroup1_EntityHardening_Defender_ILP(int attackerBudget) {
		try {
			cplex = new IloCplex();
	...
	public static void main(String args[]) {
		...
		for (int bgt=3;bgt<8;bgt++) {
			DataGroup1_EntityHardening_Defender_ILP ex = new DataGroup1_EntityHardening_Defender_ILP(attackerBgt);			
