...
public class DataGroup5_EntityHardening_Defender_ILP {
	private int K=1;
	...
	public DataGroup5_EntityHardening_Defender_ILP(int attackerBudget) {
		try {
			cplex = new IloCplex();
	...
	public static void main(String args[]) {
		...
		for (int bgt=1;bgt<8;bgt++) {
			DataGroup5_EntityHardening_Defender_ILP ex = new DataGroup5_EntityHardening_Defender_ILP(attackerBgt);
