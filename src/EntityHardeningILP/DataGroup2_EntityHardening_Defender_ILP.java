...
public class DataGroup2_EntityHardening_Defender_ILP {
	private int K=1;
	...
	public DataGroup2_EntityHardening_Defender_ILP(int attackerBudget) {
		try {
			cplex = new IloCplex();
	...
	public static void main(String args[]) {
		...
		for (int bgt=5;bgt<8;bgt++) {
			DataGroup2_EntityHardening_Defender_ILP ex = new DataGroup2_EntityHardening_Defender_ILP(attackerBgt);
