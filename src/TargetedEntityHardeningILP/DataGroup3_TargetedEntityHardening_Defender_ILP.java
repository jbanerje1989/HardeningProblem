...
import KVulnerableEntityILP.DataGroup3_KVN;
import ilog.concert.*;
import ilog.cplex.*;

public class DataGroup3_TargetedEntityHardening_Defender_ILP {
	private int K=1;
	...
	DataGroup3_KVN attackerILP; // attackerILP // ent hard
	...
	public DataGroup3_TargetedEntityHardening_Defender_ILP(int attackerBudget) {
		try {
			cplex = new IloCplex();
	...
	public void optimize() {
		try {
			...
			attackerILP = new DataGroup3_KVN();			
	...
	public static void main(String args[]) {
		...
		for (int bgt=3;bgt<8;bgt++) {
			DataGroup3_TargetedEntityHardening_Defender_ILP ex = new DataGroup3_TargetedEntityHardening_Defender_ILP(attackerBgt);
