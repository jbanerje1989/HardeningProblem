...
import KVulnerableEntityILP.DataGroup4_KVN;
import ilog.concert.*;
import ilog.cplex.*;

public class DataGroup4_TargetedEntityHardening_Defender_ILP {
	private int K=1;
	...
	DataGroup4_KVN attackerILP; // attackerILP // ent hard
	...
	public DataGroup4_TargetedEntityHardening_Defender_ILP(int attackerBudget) {
		try {
			cplex = new IloCplex();
	...
	public void optimize() {
		try {
			...
			attackerILP = new DataGroup4_KVN();			
	...
	public static void main(String args[]) {
		...
		for (int bgt=5;bgt<8;bgt++) {
			DataGroup4_TargetedEntityHardening_Defender_ILP ex = new DataGroup4_TargetedEntityHardening_Defender_ILP(attackerBgt);
