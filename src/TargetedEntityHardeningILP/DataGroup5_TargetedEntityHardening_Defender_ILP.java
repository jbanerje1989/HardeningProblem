...
import KVulnerableEntityILP.DataGroup5_KVN;
import ilog.concert.*;
import ilog.cplex.*;

public class DataGroup5_TargetedEntityHardening_Defender_ILP {
	private int K=1;
	...
	DataGroup5_KVN attackerILP; // attackerILP // ent hard
	...
	public DataGroup5_TargetedEntityHardening_Defender_ILP(int attackerBudget) {
		try {
			cplex = new IloCplex();
	...
	public void optimize() {
		try {
			...
			attackerILP = new DataGroup5_KVN();			
	...
	public static void main(String args[]) {
		...
		int attackerBgt = 8;
		for (int bgt=1;bgt<8;bgt++) {
			DataGroup5_TargetedEntityHardening_Defender_ILP ex = new DataGroup5_TargetedEntityHardening_Defender_ILP(attackerBgt);
