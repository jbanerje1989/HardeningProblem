...
import KVulnerableEntityILP.DataGroup1_KVN;
import ilog.concert.*;
import ilog.cplex.*;

public class DataGroup1_TargetedEntityHardening_Defender_ILP {
	private int K=1;
    ...
    DataGroup1_KVN attackerILP; // attackerILP // ent hard
	...
	DataGroup1_TargetedEntityHardening_Defender_ILP(int attackerBudget) {
		try {
			cplex = new IloCplex();
	...
	public static void main(String args[]) {
		...
		int attackerBgt = 8;
		for (int bgt=3;bgt<8;bgt++) {
			DataGroup1_TargetedEntityHardening_Defender_ILP ex = new DataGroup1_TargetedEntityHardening_Defender_ILP(attackerBgt);			
